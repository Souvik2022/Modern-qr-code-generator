...
export const Plans = () => {
  ...
  return (
    <section id="plans" className="py-20 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-700">
        ...
        <div className="flex justify-center">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl">
            {plans.map((plan, index) => (
              <Card 
                key={plan.name} 
                className={`relative p-8 border-0 rounded-3xl transition-all duration-200 hover:-translate-y-1 ${
                  plan.popular 
                    ? "bg-gradient-to-br from-white to-blue-50 dark:from-slate-800 dark:to-slate-700 ring-2 ring-indigo-500/50" 
              ...
              >
                ...
                <CardHeader className="text-left pb-8">
                  <div className={`w-16 h-16 mb-4 rounded-2xl flex items-center justify-center ${
                    ...
                    <Star className={`w-8 h-8 ${plan.popular ? "text-white" : "text-slate-600 dark:text-slate-300"}`} />
                  </div>
                ...
                <CardContent>
                  ...
                  <Button 
                    ...
                    size="lg"
                    className={`w-full font-semibold py-3 rounded-xl transition-all duration-200 hover:-translate-y-1 ${
                      plan.popular 
