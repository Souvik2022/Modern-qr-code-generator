    ...
    <section className="py-20 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold font-inter mb-6 text-slate-800 dark:text-slate-200 tracking-tight">
            Why Choose Our{" "}
          ...
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-4 font-inter tracking-tight">
                  {feature.title}
                </h3>
